...
async function getGMXpriceArbi() {
   ...
   //console.log('GMX price in Arbitrum: '+ gmx_usdc);
   return (gmx_usdc);
};
...
async function getGMXpriceAvax() {
  ...
  //console.log('GMX price in Avax: ' + price);
  return (price);
}
...
async function priceDiff() {
  try {
    ...
    //console.log('GMX price in Arbitrum: ' + GMX_Arbi);
    //console.log('GMX price in Avax: ' + GMX_Avax);
